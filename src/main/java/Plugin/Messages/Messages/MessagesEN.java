...
public record MessagesEN() {
    ...
    public MessagesEN() {
        ...
        //Teams
        enMessages.put(Teams_InvalidArg, prefix + ColorError + "Invalid Arguments, help");
        enMessages.put(Teams_InTeam, prefix + ColorError + "You must be in a team to do that");
        enMessages.put(Teams_InternalError, prefix + ColorError + "Something went wrong while executing that command, please report it to your server owners");
        enMessages.put(Teams_NotInTeam, prefix + ColorError + "You must leave your team before doing that");
        enMessages.put(Teams_NeedOwner, prefix + ColorError + "You must be the owner of the team to do that");
        enMessages.put(Teams_NeedAdmin, prefix + ColorError + "You must be admin or owner of the team to do that");
        enMessages.put(Teams_NeedPlayer, prefix + ColorError + "You must be a player to do that");
        enMessages.put(Teams_NoPlayer, prefix + ColorError + "Specified player not found");
        enMessages.put(Teams_NotTeam, prefix + ColorError + "That team does not exist try " + ColorLink + "/team create <name>");
        enMessages.put(Teams_NeedSameTeam, prefix + ColorError + "You are not in the same team as that person");
        enMessages.put(Teams_NoPerm, prefix + ColorError + "You do not have permission to do that");
        enMessages.put(Teams_BannedChar, prefix + ColorError + "Character you tried to use is banned");
        enMessages.put(Teams_NoTeam, prefix + ColorError + "That team does not exist");
        enMessages.put(Teams_Loading, prefix + Colorinfo + "Loading");
        enMessages.put(Teams_Create_Exists, prefix + ColorError + "That team already exists");
        enMessages.put(Teams_Create_Success, prefix + ColorSuccess + "Your team has been created");
        enMessages.put(Teams_Create_Banned, prefix + ColorError + "That team name is banned");
        enMessages.put(Teams_Create_maxLength, prefix + ColorError + "That team name is too long");
        enMessages.put(Teams_Leave_Success, prefix + ColorSuccess + "You have left the team");
        enMessages.put(Teams_Leave_LastOwner, prefix + Colorinfo + "You are the only owner rank within the team, Either promote someone else or use '/team disband' to disband command. the team");
        enMessages.put(Teams_Announce_disband, prefix + Colorinfo + "Team [0] has been disbanded");
        enMessages.put(Teams_Description_Success, prefix + ColorSuccess + "You have successfully logged in!");
        enMessages.put(Teams_Description_View, prefix + Colorinfo + "Team Description: [0]");
        enMessages.put(Teams_Description_NoDesc, prefix + ColorError + "No team description set");
        enMessages.put(Teams_Description_NoPerm, prefix + ColorError + "You do not have permission to edit the description");
        enMessages.put(Teams_Name_Success, prefix + ColorSuccess + "You have changed the team name");
        enMessages.put(Teams_Name_View, prefix + Colorinfo + "Team name: [0]");
        enMessages.put(Teams_Name_Exists, prefix + ColorSuccess + "That team already exists");
        enMessages.put(Teams_Name_NoPerm, prefix + ColorError + "You do not have permission to change your team name");
        enMessages.put(Teams_Name_Invite, prefix + ColorSuccess + "You have invited [0]");
        enMessages.put(Teams_Invite_Success, prefix + ColorSuccess + "That player has been invited");
        enMessages.put(Teams_Invite_Invite, prefix + Colorinfo + "You have been invited to join team [0] do " + ColorLink + "/team join <NameTeam> " + Colorinfo + " to join the team");
        enMessages.put(Teams_Invite_Hover, prefix + Colorinfo + "Click to join");
        enMessages.put(Teams_Invite_InTeam, prefix + ColorError + "That player is already in a team");
        enMessages.put(Teams_Invite_Banned, prefix + ColorError + "That player is banned from your team");
        enMessages.put(Teams_Invite_Full, prefix + ColorError + "Your team is maximum size, kick someone out before inviting more people");
        enMessages.put(Teams_Invite_Expired, prefix + ColorError + "The invite from [0] has expired");
        enMessages.put(Teams_join_Success, prefix + ColorSuccess + "You have joined that team");
        enMessages.put(Teams_join_Notify, prefix + ColorSuccess + "Welcome [0] to the team!");
        enMessages.put(Teams_join_NotInvited, prefix + Colorinfo + "You have not been invited to that team");
        enMessages.put(Teams_join_Banned, prefix + ColorError + "You are banned from that team");
        enMessages.put(Teams_join_Full, prefix + ColorError + "That team is full");
        enMessages.put(Teams_Open_SuccessOpen, prefix + ColorSuccess + "Your team now open to everyone");
        enMessages.put(Teams_Open_SuccessClose, prefix + ColorSuccess + "Your team is now invite only'");
        enMessages.put(Teams_Title_Change, prefix + ColorSuccess + "Your title has been changed to [0]");
        enMessages.put(Teams_Title_Remove, prefix + ColorSuccess + "Your title has been removed");
        enMessages.put(Teams_Title_Success, prefix + ColorSuccess + "That title has been changed");
        enMessages.put(Teams_Title_TooLong, prefix + ColorError + "Your title is too long");
        enMessages.put(Teams_Title_NoFormat, prefix + ColorError + "You do not have permission to format titles");
        enMessages.put(Teams_Title_NoColor, prefix + ColorError + "You do not have permission to color titles");
        enMessages.put(Teams_Title_Reset, prefix + ColorSuccess + "Your title has been reset");
        enMessages.put(Teams_Title_NoPerm, prefix + ColorError + "You do not have permission to change your team title");
        enMessages.put(Teams_Kick_Success, prefix + ColorSuccess + "That player has been kicked");
        enMessages.put(Teams_Kick_Notify, prefix + Colorinfo + "&6You have been kicked from team [0]");
        enMessages.put(Teams_Kick_NoPerm, prefix + ColorError + "&6You do not have permission to kick that person");
        enMessages.put(Teams_Ban_Success, prefix + Colorinfo + "That player has been banned");
        enMessages.put(Teams_Ban_Notify, prefix + ColorError + "You have been banned from team [0]");
        enMessages.put(Teams_Ban_NoPerm, prefix + ColorError + "You do not have permission to ban that person");
        enMessages.put(Teams_Ban_Already, prefix + ColorError + "That player is already banned");
        enMessages.put(Teams_Unban_Success, prefix + ColorSuccess + "you have unbanned them");
        enMessages.put(Teams_Unban_Notify, prefix + Colorinfo + "You have been unbanned from team [0]");
        enMessages.put(Teams_Unban_NoPerm, prefix + ColorError + "You do not have permission to unban that person");
        enMessages.put(Teams_Unban_Not, prefix + ColorError + "That player is not banned");
        enMessages.put(Teams_Promote_Success, prefix + ColorSuccess + "That player has been promoted");
        enMessages.put(Teams_Promote_NoPerm, prefix + ColorError + "You do not have permissions to promote that person");
        enMessages.put(Teams_Promote_Max,prefix + ColorError + "That person is already promoted to the max!");
        enMessages.put(Teams_Promote_Notify, prefix + ColorSuccess + "You have been promoted");
        enMessages.put(Teams_Promote_MaxAdmins, prefix + ColorError + "Your team already has the maximum number of admins, demote someone or level your team up");
        enMessages.put(Teams_Promote_MaxOwners, prefix + ColorError + "Your team already has the maximum number of owners, demote someone or level your team up");
        enMessages.put(Teams_Demote_Success, prefix + ColorSuccess + "you have degraded it");
        enMessages.put(Teams_Demote_NoPerm, prefix + ColorError + "You do not have permissions to demote that person");
        enMessages.put(Teams_Demote_Min, prefix + ColorError + "That person is already the lowest rank");
        enMessages.put(Teams_Demote_Notify, prefix + ColorSuccess + "You have been demoted");
        enMessages.put(Teams_Demote_LastOwner, prefix + Colorinfo + "You cannot demote the final owner, promote someone else first");
        enMessages.put(Teams_Demote_MaxAdmins, prefix + ColorError + "Your team already has the maximum number of admins, remove and admin or level your team up");
        enMessages.put(Teams_Chat_Enabled, prefix + Colorinfo + "Your messages now go to the team chat");
        enMessages.put(Teams_Chat_Disabled, prefix + Colorinfo + "Your messages now go to the global chat");
        enMessages.put(Teams_Color_Success, prefix + ColorSuccess + "Your team color has been changed");
        enMessages.put(Teams_Color_Fail, prefix + ColorError + "That is not a recognised chat color");
        enMessages.put(Teams_Color_Banned, prefix + ColorError + "That color code is banned");
        enMessages.put(Teams_Ally_Already, prefix + ColorError + "You are already allies");
        enMessages.put(Teams_Ally_Success, prefix + ColorSuccess + "Your teams are now allies");
        enMessages.put(Teams_Ally_Ally, prefix + Colorinfo + "Your team is now allied with [0]");
        enMessages.put(Teams_Ally_Requested, prefix + ColorError + "An ally request has been sent to that team");
        enMessages.put(Teams_Ally_Request, prefix + ColorSuccess + "[0] has sent an ally request, use " + ColorLink + " /team ally <team> " + Colorinfo + " &6to accept");
        enMessages.put(Teams_Ally_Self, prefix + ColorError + "You cannot ally your own team");
        enMessages.put(Teams_Ally_From, prefix + ColorError + "You have ally requests from: [0]");
        enMessages.put(Teams_Ally_NoRequests, prefix + ColorError + "You do not have any ally requests");
        enMessages.put(Teams_Ally_OnJoin, prefix + ColorSuccess + "You have new ally requests do " + ColorLink + "/team ally " + Colorinfo + "to view them");
        enMessages.put(Teams_Ally_Limit, prefix + ColorError + "The limit on allies has been reached");
        enMessages.put(Teams_Ally_AlreadyRequest, prefix + ColorError + "You have already requested to be allies with that team");
        enMessages.put(Teams_AllyChat_Disabled, prefix + Colorinfo + "Your messages are no longer going to the ally chat");
        enMessages.put(Teams_AllyChat_Enabled, prefix + Colorinfo + "Your messages are now going to the ally chat");
        enMessages.put(Teams_Neutral_Self, prefix + ColorSuccess + "That is your own team");
        enMessages.put(Teams_Neutral_RequestRemove, prefix + ColorSuccess + "That ally request has been removed");
        enMessages.put(Teams_Neutral_Reject, prefix + ColorSuccess + "Your ally request with [0] has been rejected");
        enMessages.put(Teams_Neutral_NotAlly, prefix + Colorinfo + "You are not allied with that team");
        enMessages.put(Teams_Neutral_Success, prefix + ColorSuccess + "You are no longer allied with that team");
        enMessages.put(Teams_Neutral_Remove, prefix + ColorSuccess + "You are no longer allied with [0]");
        enMessages.put(Teams_SetOwner_Use, prefix + Colorinfo + "You cannot promote that player, use " + ColorLink + "/team setowner <player> " + Colorinfo + "to promote that player to owner");
        enMessages.put(Teams_SetOwner_success, prefix + ColorSuccess + "That player is now owner");
        enMessages.put(Teams_SetOwner_notify, prefix + Colorinfo + "You are now owner of your team");
        enMessages.put(Teams_SetOwner_max, prefix + Colorinfo + "That player is already owner");
        enMessages.put(Teams_Pvp_Enabled, prefix + Colorinfo + "Pvp has been enabled for your team");
        enMessages.put(Teams_Pvp_Disabled, prefix + Colorinfo + "Pvp has been disabled for your team");
        enMessages.put(Teams_Tag_Banned, prefix + ColorError + "That tag is banned");
        enMessages.put(Teams_Tag_Success, prefix + ColorSuccess + "Your tag has successfully changed");
        enMessages.put(Teams_Tag_MaxLength, prefix + ColorError + "Your tag is too long");
        enMessages.put(Teams_Tag_NoPerm, prefix + ColorError + "You do not have permission to change the team tag");
        //Invetarios
