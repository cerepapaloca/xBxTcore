...
public enum Messages {
    ...
    Inventory_MenuKit_TpLobby,
    Inventory_MenuKit_TpCreatorKits,
    Inventory_PreviewKit_Title,
    Inventory_InvItemFrame_Title,
    Inventory_Generic_Exit,
    Inventory_PreviewKit_Load_Title,
    Inventory_PreviewKit_Load_lore,
    Inventory_Generic_Previous,
    Inventory_Generic_Next,
    Inventory_KitList_InvClear,
    Inventory_KitList_Title,
    Inventory_KitMenu_Title,
    Inventory_KitListBedrock_Title,
    Inventory_PreviewOn,
    Inventory_PreviewOff,
    Inventory_MenuDuel_Title,
    Inventory_MenuDuel_SendQuest,
    Inventory_MenuDuel_InvPlayers_title,
    Inventory_MenuDuel_SelectKit,
    Inventory_MenuDuel_TimeLimit_Title,
    Inventory_MenuDuel_SelectWorld_Title,
    Inventory_MenuDuel_InvPlayers_Lore,
    Inventory_MenuDuel_InvPlayersEmpty_Lore,
    Inventory_MenuDuel_SelectKit_Lore,
    Inventory_MenuDuel_SelectKitEmpty_Lore,
    Inventory_MenuDuel_TimeLimit_Lore,
    Inventory_MenuDuel_TimeLimitDisabled_Lore,
    Inventory_MenuDuel_SelectWorld_Lore,
    Inventory_MenuDuel_TimeLimit_On,
    Inventory_MenuDuel_TimeLimit_Off,
    Inventory_MenuDuel_TimeLimit_ItemLore,
    Inventory_MenuKit_SeleMode_SelectKitFavorite,
    Inventory_MenuDuel_TimeLimit_M1mas,
    Inventory_MenuDuel_TimeLimit_S1mas,
    Inventory_MenuDuel_TimeLimit_S1menos,
    Inventory_MenuDuel_TimeLimit_M1menos,
    Inventory_MenuHelp_Title,
    Inventory_MenuHelp_Command,
    Inventory_MenuHelp_Command_Lore,
    Inventory_MenuHelp_Item,
    Inventory_MenuHelp_Item_Lore,
    Inventory_MenuHelp_Item_EspecialItem_FERMENTED_SPIDER_EYE_Lore,
    Inventory_MenuHelp_Item_EspecialItem_CHARCOAL_Lore,
    Inventory_MenuHelp_Item_EspecialItem_SCUTE_Lore,
    Inventory_MenuHelp_Item_EspecialItem_FLINT_Lore,
    Inventory_MenuHelp_Item_EspecialItem_NETHERITE_SCRAP_Lore,
    Inventory_MenuHelp_Item_ArmorItem_Title,
    Inventory_MenuHelp_Item_ArmorItem_Lore,
    Inventory_MenuHelp_Item_CoinP_Title,
    Inventory_MenuHelp_Item_CoinP_Lore,
    Inventory_MenuHelp_Item_CoinS_Title,
    Inventory_MenuHelp_Item_CoinS_Lore,
    Inventory_MenuHelp_Item_CoinT_Title,
    Inventory_MenuHelp_Item_CoinT_Lore,
    Inventory_MenuHelp_Rules,
    Inventory_MenuHelp_Rules_Lore,
    Inventory_MenuHelp_Info,
    Inventory_MenuHelp_Info_Lore,
    Inventory_MenuHelp_Info_xBxTCore_lore,
    //otros
    Others_AddVIPTitle,
