...
public record MessagesES() {
    ...
    public MessagesES() {
        ...
        //teams
        esMessages.put(Teams_InvalidArg, prefix + ColorError + "Argumentos no válidos, ayuda");
        esMessages.put(Teams_InTeam, prefix + ColorError + "Debes estar en un equipo para hacer eso");
        esMessages.put(Teams_InternalError, prefix + ColorError + "Algo salió mal al ejecutar ese comando, por favor repórtalo a los propietarios de tu servidor");
        esMessages.put(Teams_NotInTeam, prefix + ColorError + "Debes abandonar tu equipo antes de hacer eso");
        esMessages.put(Teams_NeedOwner, prefix + ColorError + "Debes ser el propietario del equipo para hacer eso");
        esMessages.put(Teams_NeedAdmin, prefix + ColorError + "Debes ser administrador o propietario del equipo para hacer eso");
        esMessages.put(Teams_NeedPlayer, prefix + ColorError + "Debes ser jugador para hacer eso");
        esMessages.put(Teams_NoPlayer, prefix + ColorError + "No se encontró el jugador especificado");
        esMessages.put(Teams_NotTeam, prefix + ColorError + "Ese equipo no existe, intenta " + ColorLink + "/team create <name>");
        esMessages.put(Teams_NeedSameTeam, prefix + ColorError + "No estás en el mismo equipo que esa persona");
        esMessages.put(Teams_NoPerm, prefix + ColorError + "No tienes permiso para hacer eso");
        esMessages.put(Teams_BannedChar, prefix + ColorError + "El personaje que intentaste usar está prohibido");
        esMessages.put(Teams_NoTeam, prefix + ColorError + "Ese equipo no existe");
        esMessages.put(Teams_Loading, prefix + Colorinfo + "Cargando");
        esMessages.put(Teams_Create_Exists, prefix + ColorError + "Ese equipo ya existe");
        esMessages.put(Teams_Create_Success, prefix + ColorSuccess + "Tu equipo ha sido creado");
        esMessages.put(Teams_Create_Banned, prefix + ColorError + "Ese nombre de equipo está prohibido");
        esMessages.put(Teams_Create_maxLength, prefix + ColorError + "El nombre del equipo es demasiado largo");
        esMessages.put(Teams_Leave_Success, prefix + ColorSuccess + "Has abandonado el equipo");
        esMessages.put(Teams_Leave_LastOwner, prefix + Colorinfo + "Eres el único propietario dentro del equipo. Promueve a otra persona o usa '/team disband' para desmantelar el equipo");
        esMessages.put(Teams_Announce_disband, prefix + Colorinfo + "El equipo [0] ha sido desmantelado");
        esMessages.put(Teams_Description_Success, prefix + ColorSuccess + "¡Has iniciado sesión correctamente!");
        esMessages.put(Teams_Description_View, prefix + Colorinfo + "Descripción del equipo: [0]");
        esMessages.put(Teams_Description_NoDesc, prefix + ColorError + "No se ha establecido ninguna descripción del equipo");
        esMessages.put(Teams_Description_NoPerm, prefix + ColorError + "No tiene permiso para editar la descripción");
        esMessages.put(Teams_Name_Success, prefix + ColorSuccess + "Ha cambiado el nombre del equipo");
        esMessages.put(Teams_Name_View, prefix + Colorinfo + "Nombre del equipo: [0]");
        esMessages.put(Teams_Name_Exists, prefix + ColorSuccess + "Ese equipo ya existe");
        esMessages.put(Teams_Name_NoPerm, prefix + ColorError + "No tienes permiso para cambiar el nombre de tu equipo");
        esMessages.put(Teams_Name_Invite, prefix + ColorSuccess + "Has invitado a [0]");
        esMessages.put(Teams_Invite_Success, prefix + ColorSuccess + "Ese jugador ha sido invitado");
        esMessages.put(Teams_Invite_Invite, prefix + Colorinfo + "Has sido invitado a unirte al equipo [0] haz " + ColorLink + "/team join <NameTeam> " + Colorinfo + " para unirte al equipo");
        esMessages.put(Teams_Invite_Hover, prefix + Colorinfo + "Haz clic para unirte");
        esMessages.put(Teams_Invite_InTeam, prefix + ColorError + "Ese jugador ya está en un equipo");
        esMessages.put(Teams_Invite_Banned, prefix + ColorError + "Ese jugador está baneado de tu equipo");
        esMessages.put(Teams_Invite_Full, prefix + ColorError + "Tu equipo tiene el tamaño máximo, expulsa a alguien antes de invitar a más personas");
        esMessages.put(Teams_Invite_Expired, prefix + ColorError + "La invitación de [0] ha expirado");
        esMessages.put(Teams_join_Success, prefix + ColorSuccess + "Te has unido a ese equipo");
        esMessages.put(Teams_join_Notify, prefix + ColorSuccess + "Bienvenido [0] al equipo!");
        esMessages.put(Teams_join_NotInvited, prefix + Colorinfo + "No has sido invitado a ese equipo");
        esMessages.put(Teams_join_Banned, prefix + ColorError + "Estás prohibido en ese equipo");
        esMessages.put(Teams_join_Full, prefix + ColorError + "Ese equipo está lleno");
        esMessages.put(Teams_Open_SuccessOpen, prefix + ColorSuccess + "Tu equipo ahora está abierto para todos");
        esMessages.put(Teams_Open_SuccessClose, prefix + ColorSuccess + "Tu equipo ahora es solo para invitados");
        esMessages.put(Teams_Title_Change, prefix + ColorSuccess + "Su título ha sido cambiado a [0]");
        esMessages.put(Teams_Title_Remove, prefix + ColorSuccess + "Su título ha sido eliminado");
        esMessages.put(Teams_Title_Success, prefix + ColorSuccess + "Ese título ha sido cambiado");
        esMessages.put(Teams_Title_TooLong, prefix + ColorError + "Su título es demasiado largo");
        esMessages.put(Teams_Title_NoFormat, prefix + ColorError + "No tiene permiso para dar formato a los títulos");
        esMessages.put(Teams_Title_NoColor, prefix + ColorError + "No tiene permiso para dar color a los títulos");
        esMessages.put(Teams_Title_Reset, prefix + ColorSuccess + "Tu título ha sido restablecido");
        esMessages.put(Teams_Title_NoPerm, prefix + ColorError + "No tienes permiso para cambiar el título de tu equipo");
        esMessages.put(Teams_Kick_Success, prefix + ColorSuccess + "Ese jugador ha sido expulsado");
        esMessages.put(Teams_Kick_Notify, prefix + Colorinfo + "&6Te han expulsado del equipo [0]");
        esMessages.put(Teams_Kick_NoPerm, prefix + ColorError + "&6No tienes permiso para expulsar a esa persona");
        esMessages.put(Teams_Ban_Success, prefix + Colorinfo + "Ese jugador ha sido expulsado");
        esMessages.put(Teams_Ban_Notify, prefix + ColorError + "Te han baneado del equipo [0]");
        esMessages.put(Teams_Ban_NoPerm, prefix + ColorError + "No tienes permiso para banear a esa persona");
        esMessages.put(Teams_Ban_Already, prefix + ColorError + "Ese jugador ya está baneado");
        esMessages.put(Teams_Unban_Success, prefix + ColorSuccess + "Las has desbaneado");
        esMessages.put(Teams_Unban_Notify, prefix + Colorinfo + "Te han desbaneado del equipo [0]");
        esMessages.put(Teams_Unban_NoPerm, prefix + ColorError + "No tienes permiso para desbanear a esa persona");
        esMessages.put(Teams_Unban_Not, prefix + ColorError + "Ese jugador no está baneado");
        esMessages.put(Teams_Promote_Success, prefix + ColorSuccess + "Ese jugador ha sido promovido");
        esMessages.put(Teams_Promote_NoPerm, prefix + ColorError + "No tienes permisos para promover a esa persona");
        esMessages.put(Teams_Promote_Max,prefix + ColorError + "Esa persona ya ha sido promovida al máximo nivel!");
        esMessages.put(Teams_Promote_Notify, prefix + ColorSuccess + "Has sido promovido");
        esMessages.put(Teams_Promote_MaxAdmins, prefix + ColorError + "Tu equipo ya tiene la cantidad máxima de administradores, degrada a alguien o sube de nivel a tu equipo");
        esMessages.put(Teams_Promote_MaxOwners, prefix + ColorError + "Tu equipo ya tiene la cantidad máxima de propietarios, degrada a alguien o sube de nivel a tu equipo");
        esMessages.put(Teams_Demote_Success, prefix + ColorSuccess + "Lo has degradado");
        esMessages.put(Teams_Demote_NoPerm, prefix + ColorError + "No tienes permisos para degradar a esa persona");
        esMessages.put(Teams_Demote_Min, prefix + ColorError + "Esa persona ya tiene el rango más bajo");
        esMessages.put(Teams_Demote_Notify, prefix + ColorSuccess + "Te han degradado");
        esMessages.put(Teams_Demote_LastOwner, prefix + Colorinfo + "No puedes degradar al propietario final, primero promueve a otra persona");
        esMessages.put(Teams_Demote_MaxAdmins, prefix + ColorError + "Tu equipo ya tiene la cantidad máxima de administradores, elimina un administrador o sube de nivel a tu equipo");
        esMessages.put(Teams_Chat_Enabled, prefix + Colorinfo + "Tus mensajes ahora van al chat del equipo");
        esMessages.put(Teams_Chat_Disabled, prefix + Colorinfo + "Tus mensajes ahora van al chat global");
        esMessages.put(Teams_Color_Success, prefix + ColorSuccess + "Se ha cambiado el color de tu equipo");
        esMessages.put(Teams_Color_Fail, prefix + ColorError + "Ese no es un color de chat reconocido");
        esMessages.put(Teams_Color_Banned, prefix + ColorError + "Ese código de color está prohibido");
        esMessages.put(Teams_Ally_Already, prefix + ColorError + "Ya son aliados");
        esMessages.put(Teams_Ally_Success, prefix + ColorSuccess + "Tus equipos ahora son aliados");
        esMessages.put(Teams_Ally_Ally, prefix + Colorinfo + "Tu equipo ahora está aliado con [0]");
        esMessages.put(Teams_Ally_Requested, prefix + ColorError + "Se ha enviado una solicitud de aliado a ese equipo");
        esMessages.put(Teams_Ally_Request, prefix + ColorSuccess + "[0] ha enviado una solicitud de aliado, usa " + ColorLink + " /team ally <team> " + Colorinfo + " &6para aceptar");
        esMessages.put(Teams_Ally_Self, prefix + ColorError + "No puedes aliarte con tu propio equipo");
        esMessages.put(Teams_Ally_From, prefix + ColorError + "Tienes solicitudes de aliado de: [0]");
        esMessages.put(Teams_Ally_NoRequests, prefix + ColorError + "No tienes ninguna solicitud de aliado");
        esMessages.put(Teams_Ally_OnJoin, prefix + ColorSuccess + "Tienes nuevas solicitudes de aliado, haz clic en " + ColorLink + "/aliado del equipo " + Colorinfo + "para verlas");
        esMessages.put(Teams_Ally_Limit, prefix + ColorError + "Se alcanzó el límite de aliados");
        esMessages.put(Teams_Ally_AlreadyRequest, prefix + ColorError + "Ya has solicitado ser aliado de ese equipo");
        esMessages.put(Teams_AllyChat_Disabled, prefix + Colorinfo + "Tus mensajes ya no van al chat de aliados");
        esMessages.put(Teams_AllyChat_Enabled, prefix + Colorinfo + "Tus mensajes ahora van al chat de aliados");
        esMessages.put(Teams_Neutral_Self, prefix + ColorSuccess + "Ese es tu propio equipo");
        esMessages.put(Teams_Neutral_RequestRemove, prefix + ColorSuccess + "Esa solicitud de aliado ha sido eliminada");
        esMessages.put(Teams_Neutral_Reject, prefix + ColorSuccess + "Tu solicitud de aliado con [0] ha sido rechazada");
        esMessages.put(Teams_Neutral_NotAlly, prefix + Colorinfo + "No eres aliado de ese equipo");
        esMessages.put(Teams_Neutral_Success, prefix + ColorSuccess + "Ya no estás aliado con ese equipo");
        esMessages.put(Teams_Neutral_Remove, prefix + ColorSuccess + "Ya no estás aliado con [0]");
        esMessages.put(Teams_SetOwner_Use, prefix + Colorinfo + "No puedes promover a ese jugador, usa " + ColorLink + "/team setowner <player> " + Colorinfo + "para promover a ese jugador a propietario");
        esMessages.put(Teams_SetOwner_success, prefix + ColorSuccess + "Ese jugador ahora es propietario");
        esMessages.put(Teams_SetOwner_notify, prefix + Colorinfo + "Ahora eres propietario de tu equipo");
        esMessages.put(Teams_SetOwner_max, prefix + Colorinfo + "Ese jugador ya es propietario");
        esMessages.put(Teams_Pvp_Enabled, prefix + Colorinfo + "El Pvp ha sido habilitado para tu equipo");
        esMessages.put(Teams_Pvp_Disabled, prefix + Colorinfo + "El Pvp ha sido deshabilitado para tu equipo");
        esMessages.put(Teams_Tag_Banned, prefix + ColorError + "Esa etiqueta está prohibida");
        esMessages.put(Teams_Tag_Success, prefix + ColorSuccess + "Tu etiqueta ha sido cambiada exitosamente");
        esMessages.put(Teams_Tag_MaxLength, prefix + ColorError + "Tu etiqueta es demasiado larga");
        esMessages.put(Teams_Tag_NoPerm, prefix + ColorError + "No tienes permiso para cambiar la etiqueta del equipo");
        //Invetarios
