...
public record MessagesES() {
    ...
    public MessagesES() {
        ...
        esMessages.put(Inventory_MenuKit_TpCreatorKits,"&b&lCrea tu kit");
        esMessages.put(Inventory_PreviewKit_Title,"&bVista previa");
        esMessages.put(Inventory_InvItemFrame_Title,"&b&lToma lo que quieras");
        esMessages.put(Inventory_Generic_Exit,"&c&lSalir");
        esMessages.put(Inventory_PreviewKit_Load_Title,"&a&lCargar Kit");
        esMessages.put(Inventory_PreviewKit_Load_lore,"Nombre: ");
        esMessages.put(Inventory_Generic_Previous,"Pagina anterior");
        esMessages.put(Inventory_Generic_Next,"Siguiente página");
        esMessages.put(Inventory_KitList_InvClear,"&b&lLimpiar inventario");
        esMessages.put(Inventory_KitList_Title,"&bLista de kits&r - &6&lHaga clic derecho&r&6 Para ver la vista previa");
        esMessages.put(Inventory_KitMenu_Title,"&bMenu Kit");
        esMessages.put(Inventory_KitListBedrock_Title, "&bLista de kits");
        ...
        esMessages.put(Inventory_MenuDuel_Title,"&b&lMenu Duelos");
        esMessages.put(Inventory_MenuDuel_SendQuest, "&2&lEnviar Petición");
        esMessages.put(Inventory_MenuDuel_InvPlayers_title, "&b&lLista de jugadores invitado");
        esMessages.put(Inventory_MenuDuel_SelectKit, "&b&lEl kit seleccionado");
        esMessages.put(Inventory_MenuDuel_TimeLimit_Title, "&b&lLimite de tiempo");
        esMessages.put(Inventory_MenuDuel_SelectWorld_Title, "&b&lMundo seleccionado");
        esMessages.put(Inventory_MenuDuel_InvPlayers_Lore, Colorinfo + "Jugadores seleccionado ");
        esMessages.put(Inventory_MenuDuel_InvPlayersEmpty_Lore, Colorinfo + "Invita a tus amigos!");
        esMessages.put(Inventory_MenuDuel_SelectKit_Lore, Colorinfo + "El kit seleccionado es: &e");
        esMessages.put(Inventory_MenuDuel_SelectKitEmpty_Lore, Colorinfo + "El kit seleccionado es el favorito");
        esMessages.put(Inventory_MenuDuel_TimeLimit_Lore, Colorinfo + "Limite de tiempo activo");
        esMessages.put(Inventory_MenuDuel_TimeLimitDisabled_Lore, Colorinfo + "Sin limite de tiempo");
        esMessages.put(Inventory_MenuDuel_SelectWorld_Lore, Colorplayer + "Seleccionado: ");
        esMessages.put(Inventory_MenuDuel_TimeLimit_On,Coloritem + "Limite de tiempo activado");
        esMessages.put(Inventory_MenuDuel_TimeLimit_Off,Coloritem + "Limite de tiempo desactivado");
        esMessages.put(Inventory_MenuDuel_TimeLimit_ItemLore, Colorinfo + "Tiempo máximo: " + Colorplayer);
        esMessages.put(Inventory_MenuKit_SeleMode_SelectKitFavorite,Coloritem  + "&lSeleccionar kit favorito");
        esMessages.put(Inventory_MenuDuel_TimeLimit_M1mas,"&21M+");
        esMessages.put(Inventory_MenuDuel_TimeLimit_S1mas,"&21S+");
        esMessages.put(Inventory_MenuDuel_TimeLimit_S1menos,"&c1S-");
        esMessages.put(Inventory_MenuDuel_TimeLimit_M1menos,"&c1M-");
        esMessages.put(Inventory_MenuHelp_Title,"&b&lMenu Ayuda");
        esMessages.put(Inventory_MenuHelp_Command,"<#FCD05C>Commandos<#FFE7A7>");
        esMessages.put(Inventory_MenuHelp_Command_Lore,"Puedes ber que hace cada comando del servidor\n \n" + ColorWarning + "⚠ Traducción limitada en Ingles ⚠");
        esMessages.put(Inventory_MenuHelp_Item,"<#19fbff>Items Box PvP<#2a7c7d>");
        esMessages.put(Inventory_MenuHelp_Item_Lore,"Puedes saber información Cada Item Del Box Pvp");
        esMessages.put(Inventory_MenuHelp_Item_EspecialItem_FERMENTED_SPIDER_EYE_Lore, "Cuando lo llevas en la mano secundaria haces un 75% más de daño pero " +
                "por cada golpe que das te baja el hambre");
        esMessages.put(Inventory_MenuHelp_Item_EspecialItem_CHARCOAL_Lore, "Cuando lo llevas en la mano secundaria y si estas menos de 16 de vida (8 corazones) das whither 3 " +
                "durante 10 segundos");
        esMessages.put(Inventory_MenuHelp_Item_EspecialItem_SCUTE_Lore, "Cuando lo lleves en la mano secundaria le haces un 125% más de daño solo cuando tiene absorción si no" +
                " le hace un -25% de daño");
        esMessages.put(Inventory_MenuHelp_Item_EspecialItem_FLINT_Lore, "Cuando lo lleves en la mano secundaria hay una posibilidad del 30% que le des ceguera por 10 segundos");
        esMessages.put(Inventory_MenuHelp_Item_EspecialItem_NETHERITE_SCRAP_Lore, "Cuando lo llevas en la mano secundaria recibes lentitud 3 por 30 segundos y resistencia al " +
                " al daño 3 por 30 segundos");
        esMessages.put(Inventory_MenuHelp_Item_ArmorItem_Title, "<#19fbff>Armadura/Herramientas<#2a7c7d>");
        esMessages.put(Inventory_MenuHelp_Item_ArmorItem_Lore,
        ...
        esMessages.put(Inventory_MenuHelp_Item_CoinP_Title, "<#19fbff>Moneda Principal<#2a7c7d>");
        esMessages.put(Inventory_MenuHelp_Item_CoinP_Lore, "Las moneda principal se usa para comprar con los aldeanos de la superficie y mejorar tu equipo. para tener " +
                ...
                " los mismo aldeanos");
        esMessages.put(Inventory_MenuHelp_Item_CoinS_Title, "<#19fbff>Moneda Menas<#2a7c7d>");
        esMessages.put(Inventory_MenuHelp_Item_CoinS_Lore, "Esta monda se consigue minada de las mina de materiales como el oro, hierro, cobre... estas se encuentra " +
                ...
                "moneda principal");
        esMessages.put(Inventory_MenuHelp_Item_CoinT_Title, "<#19fbff>Moneda De Tier<#2a7c7d>");
        esMessages.put(Inventory_MenuHelp_Item_CoinT_Lore, "La moneda tier esta solo se usa para mejorar tu armadura y pico y espada. Esta se consigue en cada torre donde " +
        ...
        esMessages.put(Inventory_MenuHelp_Rules,"<#FC5C5C>Reglas<#FFDD91>");
        esMessages.put(Inventory_MenuHelp_Rules_Lore,"Puedes saber las reglas de este servidor");
        esMessages.put(Inventory_MenuHelp_Info,"<#19fbff>info<#2a7c7d>");
        esMessages.put(Inventory_MenuHelp_Info_Lore,"Puedes saber información general del server\n \n" + ColorWarning + "⚠ Traducción limitada en Ingles ⚠");
        esMessages.put(Inventory_MenuHelp_Info_xBxTCore_lore, "El plugin xBxT Core es un plugin privado encargado del funcionamiento principal del servidor" +
